...
export default {
  data() {
    return {
      ...
      SINA_PATH2:'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal',
      editor: null,
      info: null,
    };
  },
  ...
  methods: {
    seteditor() {
        this.editor = new E(this.$refs.editor)
                ...
                this.editor.config.uploadImgServer =  "http://47.111.178.85:9090/site/file/batchUpload";// 填写配置服务器端地址
      ...
      //   "http://47.111.178.85:9090/site/file/batchUpload"; // 配置服务器端地址
